...
class Image extends File {
	...
	public static function imagecopymerge_alpha(&$dest_img, &$src_img, $dest_x, $dest_y, $src_x, $src_y, $src_width, $src_height, $alpha){
		$new_src = imagecreatetruecolor($src_width, $src_height);
		imagefill($new_src,0,0, imagecolorallocatealpha($new_src,255,255,255,127));
		for ($x=0; $x < $src_width; $x++){
			for ($y=0; $y < $src_height; $y++){
				...
				$newColor = imagecolorallocatealpha($src_img,$color["red"],$color["green"],$color["blue"], $new_alpha);
				imagesetpixel($new_src,$x,$y,$newColor);
			}
		}
