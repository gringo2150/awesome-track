...
class SiteTree extends DataObject implements PermissionProvider,i18nEntityProvider {
	...
	*/
	...
	public function MetaTags($includeTitle = true) {
		...
		$tags .= "<meta name=\"generator\" content=\"Simple CMS - http://www.simple-it-solutions.com\" />\n";
	...
	function requireDefaultRecords() {
		...
		if($this->class == 'SiteTree' && self::$create_default_pages) {
			if(!SiteTree::get_by_link('home')) {
				$homepage = new Application();
				$homepage->Title = 'Application';
				$homepage->Content = '<p></p>';
				$homepage->URLSegment = 'home';
				$homepage->Status = 'Published';
				$homepage->Sort = 1;
				$homepage->CanViewType = 'LoggedInUsers';
				$homepage->write();
				$homepage->publish('Stage', 'Live');
				$homepage->flushCache();
				DB::alteration_message('Application page created', 'created');
			}
		}
