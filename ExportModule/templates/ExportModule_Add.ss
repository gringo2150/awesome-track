...
function ExportModule_Add(pWindow, pForm) {
	var window = new Ext.Window({
		title: 'Export Module Options',
		layout: 'fit',
		height: 233,
		width: 600,
		border: false,
		...
		buttons: [{
			...
			handler: function() {
				...
				pForm.submit({
					url: 'home/saveSingleObject/ExportModule',
					waitMsg: 'Creating new Export Module...',
					params: {
						module: 'ExportModule'
					},
					...
					success: function(fp, o){
						...
						pWindow.close();
						window.close();
						msg('Success', 'New Export Module has been added.');
					}
				});
			}
		}]
